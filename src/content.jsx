    ...
    <main className="main">
      <section className="home" id="home">
        <div className="home-container container grid">
          <img
            className="home-img"
            src="src/assets/image/undraw_online_learning_re_qw08.svg"
          ...
          <div className="text-content">
            ...
            <p className="description">
              Temukan Bakatmu dan Berkembang Bersama Komunitas Sekolah,
              Pendidikan Berkualitas yang Menginspirasi di Setiap Langkah,
              Menjadikan Masa Depan yang Gemilang melalui Pendidikan Berkualitas
            </p>
            <a
              className="button btn-flex"
              href="https://ppdb.smkpd3kediri.sch.id/"
            >
          ...
          <div className="home-social">
            ...
            <div className="social-links">
              <a
                href="https://www.facebook.com/smkpawyatandaha3kediri/?locale=id_ID"
              ...
              <a
                href="https://www.instagram.com/explore/locations/1806310626284697/smk-pawyatan-daha-3-kediri/?hl=id"
                className="social-link"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <section className="about section container" id="about">
        <div className="about-container grid">
          <img
            src="src/assets/image/undraw_design_inspiration_re_tftx.svg"
            alt="tentang plantshop"
            className="about-img"
          />
          ...
          <div className="about-data">
            ...
            <p className="about-desc">
              Kami memiliki tekad untuk melahirkan generasi siswa yang tidak
              hanya siap menghadapi tantangan di dalam negeri, tetapi juga
            ...
            <div className="about-detail">
              ...
              <p className="detail-desc">
                <i className="ri-checkbox-fill detail-icon"></i>
                membantu siswa mengembangkan nilai-nilai seperti integritas,
                disiplin, rasa tanggung jawab, kepedulian, dan kepemimpinan.
              </p>
              <p className="detail-desc">
                <i className="ri-checkbox-fill detail-icon"></i>
                kami mempersiapkan siswa kami untuk menghadapi tantangan masa
                depan
              </p>
              <p className="detail-desc">
                <i className="ri-checkbox-fill detail-icon"></i>
            ...
            <a className="btn-link btn-flex" href="#">
              Daftar Sekarang{" "}
              <i className="ri-arrow-right-down-line btn-icon"></i>
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="steps section container">
        <div className="steps-bg">
          <h2 className="section-title-center steps-title">
            Smk Daha 3 Kediri <br /> Jurusan
          </h2>
          <div className="steps-container grid">
            <div className="steps-card">
              <div className="card-numb">
                <img
                  src="assets/img/undraw_progressive_app_m-9-ms.svg"
                  alt=""
                />
              </div>
              <h3 className="card-title">Teknik Komputer dan informasi</h3>
              <p className="card-desc">
                Jurusan Teknik Komputer dan Informatika: Menggali Potensi di Era
                Teknologi
              </p>
            </div>
            <div className="steps-card">
              ...
              <p className="card-desc">
                Desain Komunikasi Visual: Mengubah Konsep menjadi Karya Visual
                yang Mengesankan
              </p>
            </div>
            <div className="steps-card">
              <div className="card-numb">
                <img
                  src="src/assets/image/undraw_automobile_repair_ywci.svg"
                  alt=""
                />
              </div>
              <h3 className="card-title">Teknik Kendaraan Ringan</h3>
              <p className="card-desc">
                Jurusan Teknik Kendaraan Ringan: Mengasah Keterampilanmu di
                Industri Mobilitas
              </p>
            </div>
            <div className="steps-card">
              <div className="card-numb">
                <img
                  src="src/assets/image/undraw_maintenance_re_59vn.svg"
                  alt=""
                />
              </div>
      ...
      <section className="questions section" id="faqs">
        <h2 className="section-title-center questions-title">
          Keuntungan Sekolah <br /> Smk Daha 3 Kediri
        </h2>
        <div className="questions-container container grid">
          <div className="questions-group"></div>
        </div>
      </section>
